package org.tsuki.seckill.service.impl;
...
import org.tsuki.seckill.dao.SeckillDao;
import org.tsuki.seckill.dao.SuccessKilledDao;
...
public class SeckillServiceImpl implements SeckillService {
    ...
    //md5盐值字符串，用于混淆MD5
    private final String slat = "aisifka2395uij!@$(@#$)#r901(#{)%!*()&()`1";
     ...
     * 3、不是所有的方法都需要事务，如只有一条修改操作，如：只读操作不需要事务控制
     */
